...
import { AuthCredentials, IRequestData, ISentencesDataWithId, SentencesData } from "../intefaces/intefaces";
...
export const setCorrectedSentenceFetch = (payload: ISentencesDataWithId) => {
